        ...
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <inertia-link :href="route('explorar')">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link :href="route('explorar')" :active="route().current('explorar')">
                                Explorar
                            </jet-nav-link>
                            <jet-nav-link :href="route('users.index')" :active="route().current('users.index')">
                                Users
                            </jet-nav-link>
                            <jet-nav-link :href="route('querys.twitch')" :active="route().current('querys.twitch')">
                                Twitch
                            </jet-nav-link>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    <jet-responsive-nav-link :href="route('explorar')" :active="route().current('explorar')">
                        Explorar
                    ...
                    <jet-responsive-nav-link :href="route('querys.twitch')" :active="route().current('querys.twitch')">
                        Twitch
                    </jet-responsive-nav-link>
